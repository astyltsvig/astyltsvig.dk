...
const da = {
  ...
  hero: {
    ...
    lede: 'Skræddersyede forretningsplatforme til CRM, ERP, booking og administration, bygget til jeres arbejdsgange. Jeg designer, udvikler og drifter dem selv, og de kører i daglig produktion hos mine kunder.',
...
const en: DeepString<typeof da> = {
  ...
  hero: {
    ...
    lede: 'Bespoke business platforms for CRM, ERP, booking and administration, built around your workflows. I design, develop and operate them myself, and they run in daily production for my clients.',
